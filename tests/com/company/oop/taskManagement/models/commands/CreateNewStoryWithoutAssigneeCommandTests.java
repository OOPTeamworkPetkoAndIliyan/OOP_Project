...
import com.company.oop.taskManagement.commands.CreateNewStoryWithoutAssignee;
...
public class CreateNewStoryWithoutAssigneeCommandTests {
    ...
    public void before() {
        ...
        this.command = new CreateNewStoryWithoutAssignee(taskManagerRepository);
